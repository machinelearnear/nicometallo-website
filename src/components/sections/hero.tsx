...
const items = [
  <h1 key="1" className="text-green font-mono text-[14px] md:text-[16px] mb-[20px] md:mb-[30px] ml-1">
    Hi, my name is
  </h1>,
  ...
  <p key="4" className="mt-5 max-w-[540px] text-lg md:text-xl text-slate leading-relaxed">
    ...
    <a href="https://aws.amazon.com/" target="_blank" rel="noreferrer" className="text-green hover:underline decoration-green/50 underline-offset-4 transition-all">AWS</a> and 
    sharing what I learn on{' '}
    <a href="https://www.youtube.com/@machinelearnear" target="_blank" rel="noreferrer" className="text-green hover:underline decoration-green/50 underline-offset-4 transition-all">YouTube</a>.
  </p>,
  <a
    key="5"
